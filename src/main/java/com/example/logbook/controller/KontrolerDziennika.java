...
public class KontrolerDziennika {
    ...
    public ModelAndView Wyswietl() {
        ...
        /* nie działa
        List<Zdarzenie> list = new ArrayList<Zdarzenie>();
        for(Zdarzenie zd:zdarzenia) {
            list.add(zd);
        }
        Collections.sort(list);
        */
        return new ModelAndView("dziennikZdarzen").addObject("zdarzenia", zdarzenia);//przekazanie kolekcji do widoku dziennikZdarzen
    }
    ...
    public ModelAndView wyswietlSystemy() {
        ...
        return new ModelAndView("systemy").addObject("system", systems);
    }
